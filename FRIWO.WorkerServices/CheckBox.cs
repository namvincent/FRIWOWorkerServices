            ...
            try
            {
                ...
                if (boxNumber.Length > 2 && boxNumber != "null")
                {
                    ...
                    if (checkSwitch == PinValue.High)
                    {
                        ...
                        if (barcode.Length == 0)
                        {
                            Console.WriteLine("Enter input within 8 seconds or press Enter to cancel:");
                            ...
                            var delayTask = Task.Delay(8000, stoppingToken); // Timeout after 8 seconds
                                ...
                                if (scan == 0)
                                {
                                    switch (barcode)
                                    {
                                        ...
                                        default:
                                            ...
                                            var requestStr1 = $"http://fvn-s-web01:5000/api/Email/Alarmwrongbox?line={line}&type=Wrong%20barcode%20content%3A%20{barcode}";

                ...
                while (testing)
                {
                    ...
                    if (p2)
                    {
                        try
                        {
                            ...
                            var requestStr = $"http://fvn-s-ws01.friwo.local:5000/api/ProcessLock/FA/InsertWeldingAsync/" + barcode.ToString() + "/" + 1;
                    ...
                    if (p3)
                    {
                        ...
                        try
                        {
                            ...
                            var requestStr = $"http://fvn-s-ws01.friwo.local:5000/api/ProcessLock/FA/InsertWeldingAsync/" + barcode.ToString() + "/" + 0;
